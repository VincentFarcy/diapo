 ...
 */
final class Version20200328221603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE illustration (id INT AUTO_INCREMENT NOT NULL, album_id INT NOT NULL, image_id INT NOT NULL, priority INT NOT NULL, featured_image TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_D67B9A421137ABCF (album_id), INDEX IDX_D67B9A423DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE illustration ADD CONSTRAINT FK_D67B9A421137ABCF FOREIGN KEY (album_id) REFERENCES album (id)');
        $this->addSql('ALTER TABLE illustration ADD CONSTRAINT FK_D67B9A423DA5256D FOREIGN KEY (image_id) REFERENCES image (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE illustration DROP FOREIGN KEY FK_D67B9A423DA5256D');
        ...
        $this->addSql('ALTER TABLE illustration DROP FOREIGN KEY FK_D67B9A421137ABCF');
